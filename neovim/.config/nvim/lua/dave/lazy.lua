...
require('lazy').setup({
    ...
    config = function()
      ...
      vim.api.nvim_create_autocmd('LspAttach', {
        ...
        callback = function(event)
          ...
          map('vrn', vim.lsp.buf.rename, '[V]isual [R]e[n]ame')

          -- Execute a code action, usually your cursor needs to be on top of an error
          -- or a suggestion from your LSP for this to activate.
          map('vca', vim.lsp.buf.code_action, '[V]iew [C]ode [A]ction', { 'n', 'x' })

          -- Find references for the word under your cursor.
          map('vrr', require('telescope.builtin').lsp_references, '[V]iew [R]efe[r]ences')

          -- Jump to the implementation of the word under your cursor.
          --  Useful when your language has ways of declaring types without an actual implementation.
          map('vI', require('telescope.builtin').lsp_implementations, '[V]iew [I]mplementation')
  ...
  -- Highlight todo, notes, etc in comments
  {
    ...
    event = 'VimEnter',
    dependencies = { 'nvim-lua/plenary.nvim', keys = {
